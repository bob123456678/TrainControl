...
{
    public static enum componentType {STRAIGHT, CURVE, DOUBLE_CURVE, SWITCH_LEFT, 
        SWITCH_RIGHT, SWITCH_THREE, SIGNAL, UNCOUPLER, END,
        SWITCH_CROSSING, OVERPASS, CROSSING , FEEDBACK_CURVE, FEEDBACK_DOUBLE_CURVE, FEEDBACK, TUNNEL, 
