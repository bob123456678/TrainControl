...
public interface ViewListener
{
    ...
    public boolean newRoute(String name, Map<Integer, Boolean> route, int s88, MarklinRoute.s88Triggers s88Trigger, boolean routeEnabled, int conditionS88, boolean conditionState);
    public void editRoute(String name, String newName, Map<Integer, Boolean> route, int s88, MarklinRoute.s88Triggers s88Trigger, boolean routeEnabled, int conditionS88, boolean conditionState);
