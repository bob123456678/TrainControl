...
public interface ViewListener
{
    ...
    public boolean newRoute(String name, Map<Integer, Boolean> route, int s88, MarklinRoute.s88Triggers s88Trigger, boolean routeEnabled, List<Integer> conditionS88s, boolean conditionState);
    public void editRoute(String name, String newName, Map<Integer, Boolean> route, int s88, MarklinRoute.s88Triggers s88Trigger, boolean routeEnabled, List<Integer> conditionS88s, boolean conditionState);
