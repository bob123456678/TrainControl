...
reviews living in the repo"* - 3,726 rows then.  The round of 2026-09-23 added 265 - five reviews and two rounds of validation - which makes
3,991 finding rows in the store now, every one of them with a status.
