...
Today it holds 87 entries - 55 OB and 32 FR, recounted from the file on 2026-09-24: eighteen entries
...
and the 2.8.2 backport validation 30 (BPV), which makes
4,514 finding rows in the store now, every one of them with a status.
