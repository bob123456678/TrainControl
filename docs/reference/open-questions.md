...
reviews living in the repo"* - 3,726 rows then.  The round of 2026-09-23 added its 64, which makes
3,790 finding rows in the store now, every one of them with a status.
