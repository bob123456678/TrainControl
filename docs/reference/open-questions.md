...
Today it holds 70 entries - 42 OB and 28 FR, recounted from the file on 2026-09-24: eighteen entries
...
reviews living in the repo"* - 3,726 rows then.  The round of 2026-09-23 added 336 - five reviews and three rounds of validation - which makes
4,075 finding rows in the store now, every one of them with a status.
