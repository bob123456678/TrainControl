...
### OB-044 - 2026-08-23 - bumpers don't allow station labels

**Kind:** bug  
**Raised from:** noticed while testing - not from a particular test  
**Filed:** 2026-08-23 01:09  
**Build:** commit fb109619, build\classes, compiled 23 Aug 00:43 - java: C:\Program Files\Java\jdk1.8.0_361\bin\java.exe

bumpers don't allow station labels to be placed via the right click menu.  check other components that also don't.  only fair place to disallow them are clickable elements like switches and signals.
