...
| **Disposition** | open - needs Adam, one sentence: was the `TopMainR0 -> TopMainPost` red on 63 and 64 occupancy shorthand, or a junction rule you want back?  Listed with the five pairings he is already working through. |
