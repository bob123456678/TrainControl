...
* v3.0.0 [Beta]
    - Features
        - Autonomy
            ...
            - Right-clicking a train on the track diagram lists only the stations autonomy itself would send it to.  Everything else it can still be sent to by hand - parking tracks, reversing points, stations you have marked as not automatic - is under "More Destinations", which is not shortened.
